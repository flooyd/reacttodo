...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SearchForm = __webpack_require__(167);
	var SearchMessage = __webpack_require__(168);
	...
	var Main = React.createClass({
	  ...
	  handleDelete: function handleDelete(todoId) {
	    var that = this;
	  ...
	  handleEdit: function handleEdit(todoId, newDescription, newCompleted) {
	    var that = this;
	    if (newDescription) {
	    ...
	    function renderTodos() {
	      if (descriptions) {
	        ...
	        for (var i = 0; i < descriptions.length; i++) {
	          ...
	          todoList.push(React.createElement(SearchMessage, { key: key,
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement("input", { type: "text", ref: "searchQuery" }),
	        React.createElement(
	          "button",
	          null,
	          "Get Todos"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchMessage = React.createClass({
	  ...
	  onFormDelete: function onFormDelete(e) {
	    e.preventDefault();
	    var todoId = this.props.todoId;
	    this.props.onDelete(todoId);
	  },

	  onFormEdit: function onFormEdit(e) {
	    e.preventDefault();
	    var todoId = this.props.todoId;
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement('input', _defineProperty({ placeholder: 'New Todo here...', ref: 'descInput', style: { display: 'inline', marginRight: '10px' }, type: 'text' }, 'ref', 'descInput')),
	            React.createElement(
	              'select',
	              { ref: 'select', style: { marginRight: '10px' }, required: 'required' },
	              React.createElement(
	                'option',
	                null,
	                'Completed?'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var URL = 'https://flooydtodo.herokuapp.com/todos';
	...
	module.exports = {
	  ...
	  editTodo: function editTodo(todoId, description, completed) {
